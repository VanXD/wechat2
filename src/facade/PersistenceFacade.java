...
import service.doservice.MaterialCountMapperProxy;
import service.doservice.MaterialMapperProxy;
...
/**
 * <p>处于Controller于Service层之间的Facade
 * <p>将后台与微信交互和数据库交互封装在一个系统中，由Facade进行与Controller的交互。
 * @author VanXD
 *
 */
@Service
